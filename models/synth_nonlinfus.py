# -*- coding: utf-8 -*-
"""synth_nonlinfus.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Xy4ICTBKCN9Ptbg35fZFUPIkwwtz_SKs
"""

# combines soundnet and resnet using nonlinear fusion
...
# load appropriate pickle with image, waveform, and corresponding labels
...
class OurSynth(nn.Module):
    def __init__(self, resnet, soundnet):
        ...
        self.fc_obj = nn.Linear(100, 12) # size is conv7_outchannel x signal_length, output is the number of classes
        self.fc_mat = nn.Linear(100, 5)
        self.soundnet = soundnet
        self.relu = nn.ReLU()
        self.fc1 = nn.Linear(512*4+1024*11,100)
    def forward(self, x0, x1, x2, x3, x_sound): # 4 images as well as waveform
        x0 = self.features(x0) # outputs of ResNet
...
# final layers of ResNet and SoundNet, as well as the
# weights of the final fully connected layer in our wrapper model
params = list(synth_model.soundnet.conv7.parameters()) + list(synth_model.features[-1].parameters()) + list(synth_model.fc1.parameters()) + list(synth_model.fc_obj.parameters()) + list(synth_model.fc_mat.parameters())
...
torch.save(synth_model.state_dict(), '/content/gdrive/My Drive/phys101_synth_relu.pth') # save trained weights and biases
